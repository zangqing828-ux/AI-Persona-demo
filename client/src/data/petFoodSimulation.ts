...
export const ownerSimulations: OwnerSimulation[] = [
  {
    personaId: 'DP001',
    productId: 'PROD001',
    initialReaction: '看到"75%动物蛋白"和"无谷配方"眼前一亮，这正是我一直在找的。但268元/1.5kg的价格让我有点犹豫，需要看看其他成分党的评价。',
    pricePerception: '合理',
    trustLevel: 72,
  ...
  },
  {
    personaId: 'DP002',
    productId: 'PROD002',
    initialReaction: '关节养护配方正是大黄需要的，氨糖软骨素的添加很专业。328元/2kg的价格在功能粮里算合理，但我需要确认鸭肉来源和氨糖含量。',
    pricePerception: '合理',
    trustLevel: 68,
    ingredientConcerns: ['氨糖和软骨素的具体含量', '鸭肉是否为主要蛋白来源', '碳水含量40%是否偏高'],
  ...
  },
  {
    personaId: 'DP003',
    productId: 'PROD001',
    initialReaction: '268元/1.5kg？这也太贵了吧，我现在买的超市粮才50块一大袋。虽然成分看起来不错，但真的超出预算太多了。',
    pricePerception: '太贵',
    trustLevel: 45,
  ...
  },
  {
    personaId: 'DP004',
    productId: 'PROD002',
    initialReaction: '关节养护？豆豆确实腿脚不太好了。但这个牌子我没听说过，不知道靠不靠谱。要不问问宠物店老板？',
    pricePerception: '偏贵',
    trustLevel: 40,
  ...
  },
  {
    personaId: 'DP005',
    productId: 'PROD001',
    initialReaction: '蛋白42%、脂肪18%、碳水25%，这个配比对需要减肥的毛球来说脂肪略高。让我算算每日热量摄入...',
    pricePerception: '合理',
    trustLevel: 65,
    ingredientConcerns: ['脂肪含量18%对减肥猫偏高', '需要确认代谢能数据', '益生菌菌株信息'],
    purchaseIntent: 'medium',
    intentScore: 58,
    keyConsiderations: [
      '高蛋白有助于维持肌肉',
...
export const petSimulations: PetSimulation[] = [
  {
    ...
    tasteAcceptance: 75,
    digestiveRisk: 'low',
    expectedBehavior: '开袋时会凑过来闻，可能会舔舔嘴。首次喂食可能会谨慎试探，但大概率会吃完。',
    physiologicalResponse: '由于添加了益生菌且无谷物，对玻璃胃布偶猫较为友好。预计便便成型良好，泪痕可能略有改善。',
    longTermSuitability: '长期食用适合度较高，高蛋白配方符合猫咪生理需求，益生菌有助于肠道健康。',
    riskFactors: ['初次换粮需要7-10天过渡期', '个别猫可能对三文鱼过敏'],
    positiveFactors: ['高动物蛋白符合猫咪天性', '无谷物减少消化负担', '益生菌改善肠道环境']
  },
  {
    personaId: 'DP002',
    productId: 'PROD002',
    ...
    tasteAcceptance: 78,
    digestiveRisk: 'low',
    expectedBehavior: '金毛通常不挑食，开袋就会兴奋。会大口吃完，可能还会舔碗。',
    physiologicalResponse: '鸭肉蛋白源避开了鸡肉过敏，消化应该顺畅。氨糖软骨素需要长期食用才能看到关节改善。',
    longTermSuitability: '关节养护功能适合5岁以上大型犬，但碳水含量略高，需注意体重管理。',
  ...
  },
  {
    ...
    tasteAcceptance: 88,
    digestiveRisk: 'low',
    expectedBehavior: '田园猫通常适应性强，高蛋白配方会非常吸引。预计会吃得很香，可能会催促加餐。',
    physiologicalResponse: '健康的田园猫消化系统强健，高蛋白配方完全可以适应。便便预计成型好，毛色可能更亮。',
    longTermSuitability: '非常适合年轻健康的田园猫，高蛋白有助于保持活力和肌肉。',
    riskFactors: ['几乎没有风险'],
  ...
  },
  {
    ...
    expectedBehavior: '老年泰迪可能因牙齿问题咀嚼困难，需要泡软。可能会挑挑拣拣，吃得比较慢。',
    physiologicalResponse: '老年犬消化功能下降，需要观察便便情况。关节养护成分对老年犬有益，但见效需要时间。',
    longTermSuitability: '功能性成分适合老年犬，但颗粒可能需要调整。建议泡软喂食。',
  ...
  },
  {
    ...
    tasteAcceptance: 85,
    digestiveRisk: 'low',
    expectedBehavior: '贪吃的英短会非常喜欢高蛋白配方，可能会吃得很快。需要控制喂食量。',
    physiologicalResponse: '脂肪18%对需要减肥的猫来说略高，可能不利于体重控制。建议减少喂食量或混合低脂粮。',
    longTermSuitability: '营养配方优秀，但对减肥猫来说需要严格控制份量。高蛋白有助于维持肌肉。',
...
export const interactionAnalyses: InteractionAnalysis[] = [
  {
    ...
    npsScore: 45,
    churnRisk: 'low',
    keyInsight: '成分党妈妈的核心诉求是"看得见的效果"，便便改善是最直观的正反馈',
    recommendation: '强化"肠道健康可视化"的营销点，提供便便对比图的用户UGC征集活动'
  },
  {
    personaId: 'DP002',
    productId: 'PROD002',
  ...
  },
  {
    ...
    npsScore: 55,
    churnRisk: 'low',
    keyInsight: '老年宠物主人对"陪伴更久"有强烈情感诉求，效果超预期会带来高忠诚度',
