                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-muted-foreground mb-3">
                          {product.brand} · {product.category} · {product.weight}
                        </p>
                        <div className="flex flex-wrap gap-2">
                          {product.sellingPoints.slice(0, 3).map((point, idx) => (
                      ...
                      <div className="mt-4 pt-4 border-t">
                        <div className="grid grid-cols-3 gap-4 text-center">
                          <div className="p-2 bg-muted/50 rounded-lg">
                            ...
                            <p className="font-semibold text-foreground">{product.proteinContent}%</p>
                          </div>
                          <div className="p-2 bg-muted/50 rounded-lg">
                            <div className="flex items-center justify-center gap-1 text-xs text-muted-foreground mb-1">
                            ...
                            <p className="font-semibold text-foreground">{product.fatContent}%</p>
                          </div>
                          <div className="p-2 bg-muted/50 rounded-lg">
                            <div className="flex items-center justify-center gap-1 text-xs text-muted-foreground mb-1">
                            ...
                            <p className="font-semibold text-foreground">{product.carbContent}%</p>
                          </div>
                        </div>
                      </div>
                    )}
          ...
          {selectedProductData ? (
            <>
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div>
                    <Label className="text-xs text-muted-foreground">主要原料</Label>
                  ...
                  <div>
                    <Label className="text-xs text-muted-foreground">功能添加</Label>
                    <div className="flex flex-wrap gap-1 mt-1">
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-1 mt-1">
                      {selectedProductData.certifications.map((cert, idx) => (
                        <Badge key={idx} className="text-xs bg-green-500/10 text-green-600 border-green-500/20">
