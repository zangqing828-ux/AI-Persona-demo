                      ...
                      <CardContent className="p-4 text-center">
                        ...
                        <p
                          className={`text-2xl font-bold ${
                            ownerResult.intentScore >= 70
                              ? "text-green-600"
                              : ownerResult.intentScore >= 50
                                ? "text-amber-600"
                                : "text-red-600"
                          }`}
                        >
                        ...
                        <Badge
                          className={`mt-2 ${getIntentColor(ownerResult.purchaseIntent)}`}
                        >
                          {ownerResult.purchaseIntent === "high"
                            ? "高"
                            : ownerResult.purchaseIntent === "medium"
                              ? "中"
                              : "低"}
                        </Badge>
                      </CardContent>
                      ...
                      <CardContent>
                        <ul className="space-y-2">
                          {ownerResult.objections.map((item, idx) => (
                            <li
                              key={`${activePersona}-objection-${idx}`}
                              className="flex items-start gap-2 text-sm"
                            >
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <Card>
                      <CardContent className="p-4 text-center">
                        ...
                        <Progress
                          value={petResult.smellAttraction}
                          className="mt-2 h-1.5"
                        />
                      </CardContent>
                    </Card>
                    <Card>
                      <CardContent className="p-4 text-center">
                        ...
                        <Progress
                          value={petResult.tasteAcceptance}
                          className="mt-2 h-1.5"
                        />
                      </CardContent>
                    </Card>
                    <Card>
                      <CardContent className="p-4 text-center">
                        ...
                        <p
                          className={`text-lg font-bold ${getRiskColor(petResult.digestiveRisk)}`}
                        >
                          {petResult.digestiveRisk === "low"
                            ? "低风险"
                            : petResult.digestiveRisk === "medium"
                              ? "中等"
                              : "高风险"}
                        </p>
                        {petResult.digestiveRisk === "low" ? (
                      ...
                      <CardContent>
                        <ul className="space-y-2">
                          {petResult.positiveFactors.map((item, idx) => (
                            <li
                              key={`${activePersona}-positive-${idx}`}
                              className="flex items-start gap-2 text-sm"
                            >
